...
/*
To calibrate the accelerometer, replace the zeros here with the minimum
and maximum raw value read from the accelerometer (raw data ranges)
*/
int AcXmin = 0, AcXmax = 10, AcYmin = 0, AcYmax = 10, AcZmin = -12600, AcZmax = 20500;
